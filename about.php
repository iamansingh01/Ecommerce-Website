...
<head>
  ...
  <title>Ecommerce Hub | Online Shopping Site for Men</title>
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <p class="mt-2">At [Ecommerce Hub], we are passionate about delivering a seamless online shopping experience. 
            We strive to provide our customers with a wide range of high-quality products, exceptional customer service,
             and a user-friendly platform that makes shopping convenient and enjoyable.
             We are dedicated to bringing you the best products from various categories, carefully curated to meet your
              diverse needs and preferences. Whether you're looking for fashion and accessories, home decor, electronics,
               or health and wellness products, we have you covered. We partner with reputable suppliers and brands to 
               ensure that every item we offer meets our rigorous standards of quality, reliability, and style.</p>
        </div>
        <div class="col-md-5 mt-3">
